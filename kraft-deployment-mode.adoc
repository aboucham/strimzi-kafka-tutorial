...
----
oc annotate k dev-cluster strimzi.io/node-pools="enabled" --overwrite
oc annotate k dev-cluster strimzi.io/kraft="disabled" --overwrite
----
...
[source, yaml,indent=0]
----
oc annotate k dev-cluster strimzi.io/kraft="migration" --overwrite
----
